...
namespace Skladiste_PI
{
    ...
    public partial class frmGlavna : Form
    {
        ...
        {
            pokreniFormu(new frmUnosRacuna());
        }
        ...
        private void pregledPostojećihToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void unosJediniceToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void jeidniceMjereToolStripMenuItem_Click(object sender, EventArgs e)
        {
            pokreniFormu(new frmPregledJedinice());
        }
