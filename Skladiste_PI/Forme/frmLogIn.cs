    ...
    public partial class frmLogIn : Form
    {
        ...
        private void btnPrijava_Click(object sender, EventArgs e)
        {
            ...
            if (logiranKorisnik==1){
                ...
                this.mainForm.PostaviStatusTekst("Korisnik: " + txtKorIme.Text + ", prijavljen od " + DateTime.Now.ToString(), 1);
                this.Close();
            }
            else if (logiranKorisnik==2)
            {
                // Provjera uspjesna - logiran admin
                this.mainForm.PostaviStatusTekst("Admin: " + txtKorIme.Text + ", prijavljen od " + DateTime.Now.ToString(), 2);
                this.Close();
            }
            else
            {
                // Provjera neuspjesna
                MessageBox.Show("Unijeli ste krive login podatke!", "Pogreška-login!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
